...
class _$PokemonStateTearOff {
  ...
  _Data data({required List<Pokemon> pokemons}) {
    return _Data(
      pokemons: pokemons,
    );
  }
...
mixin _$PokemonState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Pokemon> pokemons) data,
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(List<Pokemon> pokemons)? data,
...
class _$_Data implements _Data {
  const _$_Data({required this.pokemons});
  ...
  @override
  String toString() {
    return 'PokemonState.data(pokemons: $pokemons)';
  }
...
abstract class _Data implements PokemonState {
  const factory _Data({required List<Pokemon> pokemons}) = _$_Data;
